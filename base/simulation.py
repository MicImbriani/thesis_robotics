...
from utils.qlearn_utils import save_element, store_distances_logs
...
class Simulation:
    ...
    def run(self):
        ...
        self.update(tick)
        save_element(self.all_form_areas, 'all_form_areas')
        dists_avgs = store_distances_logs(self.formation.dists,
                                          self.swarm.robots)
        save_element(dists_avgs, 'dists_avgs')
